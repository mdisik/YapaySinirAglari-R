...
par(mfrow=c(2,3))
lapply(1:9, function(x) image(rotate(matrix(unlist(train_mnist[x,-1]),nrow = 28,byrow =TRUE)),col=grey.colors(255),xlab = train_mnist[x,1]))
...
newdata=h2o.predict(model,as.h2o(test_mnist))
